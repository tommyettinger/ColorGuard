...
//0
            "Infantry", new PieceKind("Infantry", "Infantry", "SL", "INFY", FOOT, "Cheap, weak, and fragile, but can occupy enemy facilities.", "", new String[]{"Occupy","Reckless","Anti-Troop",}, new String[]{"Power",""}, "Full Auto", 2, new String[]{"Assault",""}, new String[]{"Machine_Gun",""}, new int[]{1, 0}, 9, 3, 10, 15, 7, new int[]{2, 2, 2, 3, 4, 4, 3, 2, 3, 4, 8,}, 68),
//1
            "Bazooka", new PieceKind("Bazooka", "Infantry_P", "SL", "BZKA", FOOT, "A cost-effective way to fight tanks and artillery.", "", new String[]{"Occupy","Reckless","Anti-Heavy",}, new String[]{"Accuracy",""}, "Armor Buster", 3, new String[]{"Pistol","Rocket"}, new String[]{"Handgun","Rocket"}, new int[]{1, 3}, 11, 4, 10, 0, 7, new int[]{2, 2, 2, 3, 4, 4, 3, 2, 3, 4, 8,}, 85),
//2
...
//3
            "Rifle Sniper", new PieceKind("Rifle Sniper", "Infantry_T", "SN", "RFSN", FOOT, "Useful for taking out other foot soldiers at medium range.", "Indirect (1,3)", new String[]{"Occupy","Stealthy","Retaliate",}, new String[]{"Defense","Speed"}, "Sneak", 3, new String[]{"Pistol","Longarm"}, new String[]{"Handgun","Handgun"}, new int[]{1, 1}, 12, 1, 10, 30, 8, new int[]{2, 2, 2, 2, 3, 3, 2, 2, 2, 4, 6,}, 92),
//4
            "Missile Sniper", new PieceKind("Missile Sniper", "Infantry_PS", "SN", "MISN", FOOT, "The cheapest way to bring down a plane or copter.", "Indirect (2,4)", new String[]{"Occupy","Anti-Aerial","",}, new String[]{"Choice",""}, "Long Shot", 1, new String[]{"","Missile"}, new String[]{"Arc_Missile",""}, new int[]{2, 0}, 14, 2, 10, 30, 9, new int[]{2, 2, 3, 4, 4, 4, 3, 2, 3, 6, 8,}, 115),
//5
            "Mortar Sniper", new PieceKind("Mortar Sniper", "Infantry_PT", "SN", "MRSN", FOOT, "Able to play the role of artillery, pinning foes, for less cost.", "Indirect (4,5)", new String[]{"Occupy","Pin","Anti-Structure",}, new String[]{"Accuracy","Speed"}, "Hunker Down", 1, new String[]{"","Cannon"}, new String[]{"","Long_Cannon"}, new int[]{0, 2}, 15, 4, 10, 10, 6, new int[]{2, 2, 2, 3, 6, 6, 3, 3, 3, 8, 8,}, 115),
//6
            "Light Tank", new PieceKind("Light Tank", "Tank", "TN", "LTNK", HEAV, "A basic sort of tank that can guard territory well.", "", new String[]{"Guard","Anti-Light","Anti-Heavy",}, new String[]{"Rotation",""}, "Rush", 3, new String[]{"Cannon","Assault"}, new String[]{"Cannon","Machine_Gun"}, new int[]{2, 1}, 17, 9, 20, 6, 10, new int[]{2, 2, 2, 3, 4, 8, 2, 3, 4, 8, 8,}, 220),
//7
            "War Tank", new PieceKind("War Tank", "Tank_P", "TN", "WTNK", HEAV, "An extremely tough tank that gives up speed for strength.", "", new String[]{"Guard","Anti-Heavy","Anti-Structure",}, new String[]{"Rotation",""}, "Rampage", 3, new String[]{"Cannon","Assault"}, new String[]{"Cannon","Machine_Gun"}, new int[]{4, 2}, 25, 13, 27, 0, 7, new int[]{2, 2, 2, 3, 8, 8, 2, 3, 3, 8, 8,}, 275),
//8
            "Heavy Cannon", new PieceKind("Heavy Cannon", "Artillery_P", "TN", "HCNN", HEAV, "A mix of tank and artillery that can counter indirect fire.", "Indirect (1,3)", new String[]{"Guard","Pin","Retaliate",}, new String[]{"Rotation","Speed"}, "Hunker Down", 2, new String[]{"Cannon",""}, new String[]{"Cannon",""}, new int[]{4, 0}, 30, 10, 24, 0, 7, new int[]{2, 2, 3, 4, 8, 8, 2, 3, 3, 8, 8,}, 275),
//9
            "Light Artillery", new PieceKind("Light Artillery", "Artillery", "AR", "LART", HEAV, "Inaccurate, but long-ranged and able to pin foes it misses.", "Indirect (3,5)", new String[]{"Pin","Anti-Structure","",}, new String[]{"Accuracy",""}, "Long Shot", 1, new String[]{"","Cannon"}, new String[]{"","Long_Cannon"}, new int[]{0, 3}, 16, 4, 14, 0, 11, new int[]{1, 2, 3, 4, 4, 8, 2, 3, 4, 8, 8,}, 180),
//10
            "AA Artillery", new PieceKind("AA Artillery", "Artillery_S", "AR", "AART", HEAV, "Able to pin flying units it misses, and obliterate ones it hits.", "Indirect (4,5)", new String[]{"Pin","Anti-Aerial","",}, new String[]{"Choice",""}, "Spotter", 1, new String[]{"","Missile"}, new String[]{"","Arc_Missile"}, new int[]{0, 3}, 17, 7, 19, 0, 15, new int[]{1, 2, 3, 4, 4, 8, 2, 3, 4, 8, 8,}, 225),
//11
            "Stealth Artillery", new PieceKind("Stealth Artillery", "Artillery_T", "AR", "SART", LIGH, "A tricky artillery that fires missiles from hiding.", "Indirect (4,5)", new String[]{"Pin","Stealthy","",}, new String[]{"Defense",""}, "Sneak", 1, new String[]{"","Missile"}, new String[]{"","Arc_Missile"}, new int[]{0, 4}, 28, 3, 16, 50, 12, new int[]{1, 2, 2, 2, 3, 4, 2, 2, 3, 4, 8,}, 215),
//12
            "Recon", new PieceKind("Recon", "Recon", "LV", "RECN", LIGH, "A quick unit that can intercept foot soldiers in rough terrain.", "", new String[]{"Seek","Coordinate","Anti-Troop",}, new String[]{"Power",""}, "Spotter", 2, new String[]{"Assault",""}, new String[]{"Machine_Gun",""}, new int[]{1, 0}, 10, 4, 15, 17, 14, new int[]{1, 2, 2, 2, 3, 4, 2, 2, 2, 8, 8,}, 148),
//13
            "AA Gun", new PieceKind("AA Gun", "Tank_S", "LV", "AAGN", LIGH, "Tank-like against flying and foot units, defending an area.", "", new String[]{"Guard","Anti-Aerial","Anti-Troop",}, new String[]{"Choice",""}, "Full Auto", 2, new String[]{"Assault",""}, new String[]{"Machine_Gun",""}, new int[]{2, 0}, 17, 4, 16, 14, 16, new int[]{2, 2, 2, 3, 4, 8, 2, 3, 4, 8, 8,}, 185),
//14
            "Flamethrower", new PieceKind("Flamethrower", "Flamethrower", "LV", "FLMT", LIGH, "Drastically more powerful against armored targets.", "", new String[]{"Anti-Structure","Anti-Heavy","Permeate",}, new String[]{"Defense",""}, "Rampage", 2, new String[]{"Chemical",""}, new String[]{"Bomb",""}, new int[]{1, 0}, 20, 4, 17, 10, 12, new int[]{1, 2, 2, 2, 4, 8, 2, 3, 3, 8, 8,}, 185),
//15
...
//18
            "Supply Truck", new PieceKind("Supply Truck", "Truck", "TR", "SPTR", LIGH, "A basic transport that can bring Super Ammo to fighters.", "Supply", new String[]{"Carry","Coordinate","",}, new String[]{"Noncombat",""}, "", 0, new String[]{"",""}, new String[]{"",""}, new int[]{0, 0}, 0, 5, 18, 10, 11, new int[]{1, 2, 3, 4, 4, 6, 3, 3, 4, 8, 8,}, 112),
//19
            "Amphi Transport", new PieceKind("Amphi Transport", "Truck_S", "TR", "AMTR", HEAV, "A different kind of transport; amphibious, with better armor.", "Supply", new String[]{"Carry","Coordinate","",}, new String[]{"Noncombat",""}, "", 0, new String[]{"",""}, new String[]{"",""}, new int[]{0, 0}, 0, 8, 18, 0, 10, new int[]{2, 2, 3, 3, 6, 8, 3, 3, 3, 2, 2,}, 140),
//20
...
//24
            "Jammer", new PieceKind("Jammer", "Truck_T", "TV", "JAMR", LIGH, "Can jam enemy signals and generate Super Ammo.", "Hack", new String[]{"Disrupt","Generate","",}, new String[]{"Noncombat",""}, "", 0, new String[]{"",""}, new String[]{"",""}, new int[]{0, 0}, 0, 5, 17, 30, 13, new int[]{1, 2, 3, 4, 4, 6, 3, 3, 4, 8, 8,}, 120),
//25
            "Build Rig", new PieceKind("Build Rig", "Truck_P", "TV", "BLDR", HEAV, "Can repair vehicles and facilities and generate Super Ammo.", "Restore", new String[]{"Carry","Generate","",}, new String[]{"Noncombat",""}, "", 0, new String[]{"",""}, new String[]{"",""}, new int[]{0, 0}, 0, 9, 21, 0, 9, new int[]{2, 2, 2, 3, 4, 4, 2, 2, 3, 8, 8,}, 150),
//26
...
//27
            "Mud Tank", new PieceKind("Mud Tank", "Tank_T", "SH", "MTNK", HEAV, "A versatile tank that can stealthily defend almost any terrain.", "", new String[]{"Stealthy","Guard","",}, new String[]{"",""}, "Sneak", 3, new String[]{"Longarm","Cannon"}, new String[]{"Handgun","Cannon"}, new int[]{1, 2}, 19, 11, 25, 20, 12, new int[]{2, 2, 2, 2, 4, 6, 2, 3, 4, 3, 4,}, 264),
//28
